    ...
    <div className={PAGE}>
      ...
      <header className='px-6 pt-36 pb-20 md:px-12 lg:px-20 lg:pt-44'>
        <div className={CONTAINER}>
          ...
          <h1
            className='mt-7 text-[clamp(2.5rem,6vw,5rem)] leading-[0.95] font-light tracking-tight text-[#111]'
          ...
          {posts.length > 0 && (
            <p className='mt-10 border-t border-black/[0.07] pt-6 font-mono text-[11px] tracking-[0.2em] text-black/45'>
            ...
            <div className={CONTAINER}>
              {posts.length === 0 ? (
                <div className='rounded-2xl border border-dashed border-black/12 px-6 py-20 text-center'>
                  ...
                  <a
                    href='/#portfolio'
                    className='mt-8 inline-flex items-center gap-2 rounded-full bg-[#111] px-6 py-3 text-[12px] tracking-wide text-white transition-colors hover:bg-black'
                  >
                ...
                <div className='grid gap-5 md:grid-cols-2 lg:grid-cols-3'>
                  {posts.map((post, i) => (
                    <Reveal key={post.slug} delay={(i % 3) * 90}>
                      <article className='group flex h-full flex-col overflow-hidden rounded-2xl border border-black/[0.07] bg-white/50 transition-all duration-300 hover:border-black/12 hover:bg-white'>
                        {post.coverImage && (
                        ...
                        <div className='flex flex-1 flex-col p-6'>
                          ...
                          <h2
                            className='mt-5 text-[20px] leading-snug font-light tracking-tight text-[#111]'
                            style={{ fontFamily: DISPLAY_FONT }}
                          >
