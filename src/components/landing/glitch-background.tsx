...
function GlitchScene({ isHovered }: GlitchSceneProps) {
  ...
  const defaultTexture = useLoader(THREE.TextureLoader, "/images/landing/bg-nature.png")
  const hoverTexture   = useLoader(THREE.TextureLoader, "/images/landing/fr-nature.png")
