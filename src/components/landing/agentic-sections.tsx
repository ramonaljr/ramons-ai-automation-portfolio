...
// ─── Main page ────────────────────────────────────────────────────────────────
export function AgenticSections() {
      ...
      <section id="workflow" className="py-32 px-6 md:px-12 lg:px-20 border-t border-black/[0.06] overflow-hidden">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3" onMouseMove={handleMouse}>
            {[
              { n: "01", title: "Define",  desc: "Describe your agent in plain language. Set objectives, tools, and boundaries.", delay: 0,   img: "/images/landing/define.png" },
              { n: "02", title: "Compose", desc: "Chain agents together in the visual editor. Wire triggers, conditions, and outputs.", delay: 80,  img: "/images/landing/compose.png" },
              { n: "03", title: "Test",    desc: "Run sandboxed simulations. Inspect every decision in the execution trace.", delay: 140, img: "/images/landing/test.png" },
              { n: "04", title: "Deploy",  desc: "Push globally in one click. Agents auto-scale, self-heal, and report back.", delay: 200, img: "/images/landing/deploy.png" },
            ].map((step) => (
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="rounded-2xl overflow-hidden border border-black/[0.07] flex flex-col md:block md:relative" onMouseMove={handleMouse}>
            ...
            <div className="relative w-full h-[280px] md:h-[480px] shrink-0">
              <img
                src="/images/landing/org-arc.png"
